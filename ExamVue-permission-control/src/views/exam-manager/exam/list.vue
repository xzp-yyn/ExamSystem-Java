  ...
  <div class="app-container">
      ...
      <el-form ref="myForm"
        ...
        <el-form-item label="考试试卷"
          ...
          <el-select v-model="form.paperId"
                     :disabled="formType === 1"
                     placeholder="请选择试卷">
            <el-option v-for="item in paperData"
                       :key="item.id"
                       :label="item.name"
                       :value="item.id" />
          </el-select>
        ...
        <el-form-item v-if="form.limitTime == 1"
                      label="考试时间设置">
        ...
        <el-form-item label="考试权限"
                      prop="privilege">
          <el-radio v-model="form.privilege"
                    :label="0">完全开放</el-radio>
          <el-radio v-model="form.privilege"
                    :label="1">需要输入密码</el-radio>
        </el-form-item>

        <el-form-item v-if="form.privilege === 1"
                      label="考试密码"
                      prop="password">
    ...
    <el-table ref="multipleTable"
      ...
      <el-table-column prop="privilege"
                       ...
                       align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.privilege === 0"
                style="color: green">完全开放</span>
          <span v-else
                style="color: red">需要密码</span>
        </template>
      </el-table-column>
...
import { queryPapers } from '@/api/admin/paper'
export default {
  name: 'ExamList',
  directives: { waves },
  data() {
