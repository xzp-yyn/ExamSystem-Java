  ...
  <div class="app-container">
        ...
        <el-col :span="16">
          ...
          <el-form ref="ruleForm"
            ...
            <el-form-item label="身份"
                          prop="role">
              <el-radio v-model="form.role"
                        label="管理员"
                        :disabled="form.id === 1">管理员</el-radio>
              <el-radio v-model="form.role"
                        label="学生"
                        :disabled="form.id === 1">学生</el-radio>
            </el-form-item>
          </el-form>
        </el-col>
        <el-col :span="8">
    ...
    <el-table ref="multipleTable"
      ...
      <el-table-column label="用户名"
        ...
        <template slot-scope="scope">
          <el-link type="primary"
                   @click="handleUpdate(scope.row)">{{ scope.row.username }}</el-link>
        </template>
      </el-table-column>
      ...
      <el-table-column label="用户身份"
                       align="center">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.role === '管理员'"
                  type="warning">管理员</el-tag>
          <el-tag v-else
                  type="success">学生</el-tag>
        </template>
      </el-table-column>
